...
import { UNITS, RESCHEDULE, APPROVED, NOT_APPROVED, CONSIGMENT_STATUS, ORDER_HOLD } from 'src/app/shared/constants';
    ...
    if(data && data.length > 0) {
      data.forEach((e: any, i: any) => {
        let a = {
          ...
          display_status: CONSIGMENT_STATUS[e.status],
          is_created_by_me: e.created_by == this.orderDetails.user_id ? true : false
        }
        this.dcList.push(a);
      });
    }
